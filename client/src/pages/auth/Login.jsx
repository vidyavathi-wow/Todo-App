  ...
  return (
    <div className="w-full max-w-md bg-gray-800 dark:bg-white p-8 rounded-2xl shadow-md border border-gray-700 dark:border-gray-300 transition-colors duration-300">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div>
          <label className="block mb-1 text-sm text-white dark:text-gray-900">Email Address</label>
          <Input
            type="email"
          ...
          />
          {errors.email && <p className="text-red-400 dark:text-red-500 text-sm mt-1">{errors.email.message}</p>}
        </div>

        <div>
          <label className="block mb-1 text-sm text-white dark:text-gray-900">Password</label>
          <Input
            type="password"
            ...
            className="w-full p-3 rounded bg-gray-700 dark:bg-gray-200 border border-gray-600 dark:border-gray-300 focus:ring-2 focus:ring-primary text-gray-light dark:text-gray-900"
          />
          {errors.password && <p className="text-red-400 dark:text-red-500 text-sm mt-1">{errors.password.message}</p>}
        ...
        <Button type="submit" disabled={loading} noDefault className="w-full bg-primary text-white py-3 rounded-md font-medium hover:bg-primary/80 transition disabled:opacity-50">
